...
@if (!is_null($course->meta_description))
@section('meta_description', $course->meta_description)
@endif

@if (!is_null($course->meta_keywords))
                                                ...
                                                @if (auth()->check())
                                                    @if (in_array($lesson->model->id, $completed_lessons))
                                                        <div class="position-absolute" style="right: 0;top:0px">
                                                            <span
                                                                class="gradient-bg p-1 text-white font-weight-bold completed">@lang('labels.frontend.course.completed')</span>
                                                        </div>
                                                    @endif
                                                @endif
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        @if ($lesson->model->live_lesson)
                                                            ...
                                                            @forelse($lesson->model->liveLessonSlots as $slot)
                                                                <div class="card">
                                                                    <div class="card-body">
                                                                        @lang('labels.frontend.course.date')
                                                                        {{ $slot->start_at->format('d-m-Y h:i A') }}
                                                                    </div>
                                                                </div>
                                                            @empty
                                                            @endforelse
                                                            ...
                                                            @if (in_array($lesson->model->id, $completed_lessons))
                                                                <div>
                                                                    <a class="btn btn-warning mt-3"
                                                                        ...
                                                                        <span
                                                                            class=" text-white font-weight-bold ">@lang('labels.frontend.course.go')
                                                                            ></span>
                                                                    </a>
                                                                </div>
                                                            @endif
                                                    ...
                                                    <div class="best-course-pic-text relative-position">
                                                        ...
                                                        <div class="best-course-text">
                                                            ...
                                                            <div class="course-meta">
                                                                ...
                                                                <span class="course-author"><a
                                                                        href="#">{{ $bundle->students()->count() }}
                                                                        @lang('labels.frontend.course.students')</a></span>
                                                                <span
                                                                    class="course-author mr-0">{{ $bundle->courses()->count() }}
                ...
                <div class="col-md-3">
                    <div class="side-bar">
                        <div class="course-side-bar-widget">
                            ...
                            @if ($courseExpire == false && !$purchased_course && $matched['matched'] == false && $matched['matchedBundle'] == false)
                                <h3>
                                    ...
                                    @else
                                        ...
                                        @lang('labels.frontend.course.price')<span>
                                            {{ $appCurrency['symbol'] . ' ' . $course->price }}</span>
                                    @endif
                                </h3>
                                ...
                                @if (auth()->check() &&
                                    ...
                                    <button
                                        class="btn genius-btn btn-block text-center my-2 text-uppercase  btn-success text-white bold-font"
                        ...
                        @if ($global_featured_course != '')
                            <div class="side-bar-widget">
                                <h2 class="widget-title text-capitalize">@lang('labels.frontend.course.featured_course')
                                </h2>
                                    ...
                                    <div class="best-course-pic-text relative-position pt-0">
                                        ...
                                        <div class="best-course-text" style="left: 0;right: 0;">
                                            <div class="course-title mb20 headline relative-position">
                                                <h3>
                                                    <a
                                                        href="{{ route('courses.show', [$global_featured_course->slug]) }}">{{ $global_featured_course->title }}</a>
                                                </h3>
                                            </div>
                                            <div class="course-meta">
                                                <span class="course-category"><a
                                                ...
                                                <span
                                                    class="course-author">{{ $global_featured_course->students()->count() }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
