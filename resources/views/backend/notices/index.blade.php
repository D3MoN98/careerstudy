                ...
                <table id="myTable" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.notices.show', $item->id) }}" class="btn btn-xs btn-primary mb-1"><i
                                        class="icon-eye"></i></a>

                                <a href="{{ route('admin.notices.edit', $item->id) }}" class="btn btn-xs btn-info mb-1"><i
                                ...
                                <a data-method="delete" data-trans-button-cancel="Cancel" data-trans-button-confirm="Delete"
                                    ...
                                    <form action="{{ route('admin.notices.destroy', $item->id) }}" method="POST" name="delete_item"
                                        style="display:none">
                                        @csrf
                                        @method('DELETE')
                                    </form>
