...
@section('content')
    {!! Form::model($notice, ['method' => 'PUT', 'route' => ["admin.$segment.update", $notice->id], 'files' => true,]) !!}
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                <div class="col-md-10">
                    {!! Form::label('is_active', 'Active', ['class' => 'control-label']) !!} <br>
                    {!! Form::select('is_active', ['No', 'Yes'], old('is_active'), ['class' => 'form-control', 'required' => true]) !!}
                </div>
            </div>
