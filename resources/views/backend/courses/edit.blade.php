            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <select name="college_type" id="college_type" class="form-control mb-0 select2-college-type" required>
                            <option></option>
                            <option value="college" {{ $course->college_type == 'college' ? 'selected' : '' }}>College</option>
                            <option value="university" {{ $course->college_type == 'university' ? 'selected' : '' }}>University</option>
                        </select>
                    </div>
                </div>
                <!--col-->
                ...
                <div class="col-12">
                    ...
                    <div class="form-group">
                        ...
                        @php
                            if (is_null($course->college_type)) {
                                $colleges = App\Models\College::all();
                            } else {
                                $colleges = App\Models\College::where('type', $course->college_type)->get();
                            }
                        @endphp
                        <select name="college_id" id="college_id" class="form-control mb-0 select2-tag-college" required>
                            <option></option>
                            @foreach ($colleges as $college)
                                <option value="{{ $college->id }}" {{ $course->college_id == $college->id ? 'selected' : '' }}>{{ $college->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="col-12">
                    ...
                    <div class="form-group">
                        ...
                        @php
                            $college_streams = App\Models\CollegeStream::where('college_id', $course->college_id)->orWhere('college_id', null)->get();
                        @endphp
                        <select name="college_stream_id" id="college_stream_id" class="form-control select2-tag-college-stream"
                            ...
                            @foreach ($college_streams as $college_stream)
                                <option value="{{ $college_stream->id }}" {{ $course->college_stream_id == $college_stream->id ? 'selected' : '' }}>{{ $college_stream->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="col-12">
                    ...
                    <div class="form-group">
                        ...
                        <select name="honour_passcourse" id="honour_passcourse" class="form-control select2-honour-passcourse">
                            <option></option>
                            <option value="honours" {{ $course->honour_passcourse == 'honours' ? 'selected' : '' }}>Honours</option>
                            <option value="pass_course" {{ $course->honour_passcourse == 'pass_course' ? 'selected' : '' }}>Pass Course</option>
                        </select>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="programme_class_id" id="programme_class_id" class="form-control select2-programme-class"
                            ...
                            @foreach ($programme_classes as $programme_class)
                                <option value="{{ $programme_class->id }}" {{ $course->programme_class_id == $programme_class->id ? 'selected' : '' }}>{{ $programme_class->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
...
<script>
    ...
    @if($course->college_type == 'university')
    $("#honour_passcourse").closest('.form-group').hide()
    @endif
