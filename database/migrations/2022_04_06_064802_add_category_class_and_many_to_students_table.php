...
class AddCategoryClassAndManyToStudentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('students', function (Blueprint $table) {
            $table->enum('college_type', ['college', 'university'])->nullable()->after('user_id');
            ...
            $table->string('category_id')->nullable()->after('programme_class_id');
